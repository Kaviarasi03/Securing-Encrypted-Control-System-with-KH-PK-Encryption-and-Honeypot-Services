...
String pro_name="du_home_response";
...
SB.setdatetime(time_req);
SB.setstatus("Normal");


SSInterface SSISB=new SSImplementation();
SSISB.doSessiondata(SB);
...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#"><%=duser.toUpperCase() %></a></li>
          <li><a class="nav-link scrollto" href="DU_Home.jsp">Home</a></li>
          <li><a class="nav-link scrollto" href="DU_FileResponse.jsp">File Response</a></li>
          <li><a class="nav-link scrollto" href="DU_DownloadFile.jsp">Download file</a></li>
