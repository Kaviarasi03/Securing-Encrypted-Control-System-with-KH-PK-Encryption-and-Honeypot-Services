...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" action="DOLogServlet" method="post">
				...
				<br> 
			 <a class="button login__submit" type="submit" href="DataOwner_Reg.jsp" style="margin-left:0px; margin-top:3.5px">Sign up here</a>
