...
<title>Cloud Server | Data User List</title>
...
<body style = "background: linear-gradient(to right,#800080, #ffc0cb);">
<div class="container">
   <h1 class="tm-blue-text tm-welcome-title tm-margin-b-35" style="color: white;">Cloud Server</h1>
    	<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary" >
					<div class="panel-heading" style = "background: linear-gradient(to right, purple, #6C5CE7);">
						<h3 class="panel-title">List of Data Users</h3>
