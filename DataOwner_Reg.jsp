...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" action="DORegServlet" method="post">
				...
				<br> 
			 <a class="button login__submit" type="submit" href="DataOwner_Log.jsp" style="margin-left:0px; margin-top:3.5px">Login</a>
