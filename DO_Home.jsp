...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#"><%=downer.toUpperCase() %></a></li>
          <li><a class="nav-link scrollto" href="DO_Home.jsp">Home</a></li>
          <li><a class="nav-link scrollto" href="DO_FUpload.jsp">Upload Files</a></li>
          <li><a class="nav-link scrollto" href="DO_ViewFiles.jsp">View Files</a></li>
