...
<title>Data Owner | View Files</title>
...
<div class="container">
   <h1 class="tm-blue-text tm-welcome-title tm-margin-b-35" style="color: white;">Data Owner uploaded Files</h1>
    	<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary" >
					<div class="panel-heading" style = "background: linear-gradient(to right, purple, #6C5CE7);">
						<h3 class="panel-title">List of Files Uploaded By <%=downer.toUpperCase() %></h3>
 ...
 try
    {
        ...
        ResultSet rs=st.executeQuery("select * from uploadfile where username='"+downer+"'");
%>
						<tbody>
							 <%
     int ii=1;
