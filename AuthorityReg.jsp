...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" action="AuthorityRegServlet" method="post">
				...
				<div class="login__field">
					<i class="login__icon fas fa-lock"></i>
					<input type="password" class="login__input" name="repeatpass" placeholder="RepeatPassword" required>
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
				...
				<br> 
			 <a class="button login__submit" type="submit" href="AuthorityLog.jsp" style="margin-left:0px; margin-top:3.5px">Login</a>
