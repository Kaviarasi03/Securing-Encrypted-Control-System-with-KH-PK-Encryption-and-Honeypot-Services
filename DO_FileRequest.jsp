...
String pro_name="au_file_request";
			...
			<div class="col-md-12">
				<div class="panel panel-primary" >
					<div class="panel-heading" style = "background: linear-gradient(to right, #ad5389, #3c1053);">
						<h3 class="panel-title">List of Requested Files</h3>
 ...
 try
    {
        ...
        ResultSet rs=st.executeQuery("select * from filerequest where fileowner='"+downer+"' and status='Waiting'");
%>
						<tbody>
							 <%
     int ii=1;
        ...
        while(rs.next())
        {
            ...
            <tr>
                ...
                <td><a class="btn btn-success btn-sm" href="FileAccept.jsp?fname=<%=rs.getString("filename") %>&reqby=<%=rs.getString("requestby") %>">Accept</a></td>
