...
<title>Authority | File Request</title>
...
<div class="container">
   <h1 class="tm-blue-text tm-welcome-title tm-margin-b-35" style="color: white;">File Response</h1>
    	<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary" >
					<div class="panel-heading" style = "background: linear-gradient(to right, #ad5389, #3c1053);">
						<h3 class="panel-title">Re-Encrypt key :  <%=authority.toUpperCase()%></h3>
 ...
 try
    {
        ...
        ResultSet rs=st.executeQuery("select * from filerequest");
%>
						<thead>
							<tr>
                        ...
                        <th><input type="text" class="form-control" placeholder="File Owner" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Requested By" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Accepted By" disabled></th>
    ...
    <td><%=rs.getString("fileowner") %></td>
    <td><%=rs.getString("requestby") %></td>
    <td><%=rs.getString("acceptby") %></td>
   <!--  <td><%=rs.getString("encrypt") %></td>   -->
    
    <td><a class="btn btn-primary sm-3" href="Reencrypt1.jsp?fname=<%=rs.getString("filename")%> &fsize=<%=rs.getString("filesize") %>  &fencrypt=<%=rs.getString("encrypt") %> &frequest=<%=rs.getString("requestby") %>">Re-Encrypt</a></td>
